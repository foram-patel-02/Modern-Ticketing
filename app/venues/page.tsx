...
const Page: React.FC = () => (
  <Master>
    <Section className='black-background'>
      <div className='container'>
        <div className='center'>
          <Heading type={1} color='gradient' text='Venues' />
          <p className='white'>Discover the best venues in London.</p>
    ...
    <CardGroup url='venues' title='Latest venues' color='gradient' background='black'>
      <VenueCard
        url='1'
    ...
    <CardGroup url='venues' title='Other venues' color='gradient' background='black'>
      <VenueCard
        url='1'
        color='gradient-badge'
        name='o2 Arena'
