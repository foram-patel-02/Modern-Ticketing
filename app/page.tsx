...
const Page: React.FC = () => (
  <Master>
    <Section className='black-background'>
      <div className='container'>
        <div className='center'>
          <Heading type={1} color='gradient' text='Discover' />
    ...
    <CardGroup url='list' title='Latest events' color='gradient' background='black'>
      <EventCard
        url='1'
        from='20'
    ...
    <CardGroup url='list' title='More events' color='gradient' background='black'>
      <EventCard
        url='1'
        from='20'
        color='gradient-badge'
    ...
    <CardGroup url='list' title='Editors choice' color='gradient' background='black'>
      <EventCard
        url='1'
        from='20'
        color='gradient-badge'
    ...
    <CardGroup url='list' title='For kids' color='gradient' background='black'>
      <EventCard
        url='1'
        from='20'
        color='gradient-badge'
